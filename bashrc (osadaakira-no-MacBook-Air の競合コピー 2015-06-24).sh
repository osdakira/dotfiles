...
alias rdmresettest="RAILS_ENV=test bin/rake db:migrate:reset"
...
export CHATWORK_API_TOKEN=${CHAT_WORK_TOKEN}
...
alias manonp1='ssh -i ~/.ssh/manon.pem ubuntu@52.68.56.218'
alias manonp2='ssh -i ~/.ssh/manon.pem ubuntu@52.68.34.34'
export PATH="/Users/osada/.homebrew/sbin:$PATH"
alias today="date '+%Y%m%d'"
alias monit="ssh -i ~/.ssh/mgn-monitor.pem ubuntu@54.248.90.137"
alias gom="gout mugenup"
alias cmd="cap mugenup deploy"
f_deploy(){
